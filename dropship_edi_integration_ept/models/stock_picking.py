                ...
                for line in reader:
                    ...
                    if product_code == '':
                        ...
                        if stock_lot_id:
                            ...
                            self.env.cr.execute("select id, lot_id from stock_move_line where product_id= " + str(stock_lot_id.product_id.id) + " and reference='" + str(order_ref_prev) + "' and importednum = false")
